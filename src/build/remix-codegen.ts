...
export interface ModuleParts {
  ...
  cursor: number;
  /** The module exports a `loader`. */
  hasLoader: boolean;
  /** The module exports an `action`. */
  hasAction: boolean;
  /** The module exports a `meta`. */
  hasMeta: boolean;
  /** The module exports a `links`. */
  hasLinks: boolean;
  /** The module exports a `handle`. */
  hasHandle: boolean;
  /** The module exports a `headers`. */
  hasHeaders: boolean;
  /** The module has a default export (a route component; absent for a resource route). */
  hasDefault: boolean;
  /** The module exports an `ErrorBoundary`. */
...
/** The header comment stamped on every generated route module. */
