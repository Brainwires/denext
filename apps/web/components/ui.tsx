...
export const NAV: {
  ...
  },
  {
    group: "Polish",
    items: [
      { slug: "i18n", label: "Internationalization" },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "deployment-targets", label: "Deployment targets" },
