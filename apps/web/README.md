...
pure HTML**. It's dogfooding: every page here is a Server Component with no
interactivity, so the build ships **0 KB of client JavaScript** — the site is
the demo of the claim.
