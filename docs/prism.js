        ...
        highlightElement: function (n, t, r) {
          ...
          if (
            a.hooks.run("before-sanity-check", s),
              (o = s.element.parentElement) && "pre" === o.nodeName.toLowerCase() &&
    ...
    if (
      e.Prism = a,
        i.stringify = function e(n, t) {
          ...
          return "<" + i.tag + ' class="' + i.classes.join(" ") + '"' + o + ">" + i.content + "</" +
            i.tag + ">";
        },
        !e.document
    ) {
      ...
      for (var e = [], a = 0; a < n.length; a++) {
        ...
        if (
          ...
          ("tag" === o.type && o.content[0] && "tag" === o.content[0].type
            ...
            : e.length > 0 && e[e.length - 1].openedBraces > 0 && "punctuation" === o.type &&
                "}" === o.content
            ? e[e.length - 1].openedBraces--
            : i = !0),
