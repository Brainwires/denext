...
| | |
|---|---|
| Generated | 2026-09-02T21:08:12.175Z |
...
| Layer | Result |
|---|---|
| **Bytes over the wire** | denext ships **~6.8× less** JavaScript (hello first load: 20.2 KB vs 137.3 KB) |
...
| **Real library app** | denext **~1.9–5.0× smaller** across recharts / react-hook-form / Radix routes |
...
|---|--:|--:|:--|
| Runtime baseline | 19.0 KB | 136.9 KB | **7.2× smaller** |

**First load** per route (all JS the route pulls, gzip):

| Route | denext | Next.js | denext advantage |
|---|--:|--:|:--|
| `/` | 20.2 KB | 137.3 KB | **6.8× smaller** |
| `/about` | 19.6 KB | 136.9 KB | **7.0× smaller** |
| `/blog/hello-world` | 19.5 KB | 136.9 KB | **7.0× smaller** |
...
|---|--:|--:|--:|--:|:--|
| structural mirror of examples/hello home + layout chrome | 51083 | 45190–51323 | 16514 | 8996–17147 | denext **3.1× faster** |
| 100-row static list (raw markup throughput) | 4414 | 3616–4416 | 1620 | 895–1626 | denext **2.7× faster** |
| 1000-row static list (raw markup throughput) | 269 | 254–284 | 134 | 82–136 | denext **2.0× faster** |
| nested function components (depth 6, fanout 3) | 500 | 385–503 | 97 | 73–99 | denext **5.2× faster** |
...
| Workload | denext ops/s | (IQR) | React ops/s | (IQR) | result |
|---|--:|--:|--:|--:|:--|
| structural mirror of examples/hello home + layout chrome | 131534 | 111438–132438 | 46080 | 24407–47490 | denext **2.9× faster** |
| 100-row static list (raw markup throughput) | 7894 | 5702–7988 | 2486 | 1432–2553 | denext **3.2× faster** |
| 1000-row static list (raw markup throughput) | 719 | 499–723 | 185 | 123–185 | denext **3.9× faster** |
| nested function components (depth 6, fanout 3) | 1117 | 703–1166 | 110 | 94–123 | denext **10.1× faster** |
...
| | denext | Next.js | denext advantage |
|---|--:|--:|:--|
| p50 | 629.2 ms | 686.3 ms | **1.1× faster** |
| p95 | 704.0 ms | 824.7 ms | **1.2× faster** |
...
|---|--:|--:|:--|
| `/` — recharts dashboard (class components) | 124.3 KB | 230.2 KB | **1.9× smaller** |
| `/form` — react-hook-form + lucide | 27.9 KB | 140.2 KB | **5.0× smaller** |
| `/ui` — Radix dialog + lucide | 29.5 KB | 142.4 KB | **4.8× smaller** |
