...
The full pages-router document render costs **+2%** over raw denext SSR of
...
Full production path: route match → prerendered/SSR HTML served for the home page.
...
_Method: 4000 requests at concurrency 50 against the home page
