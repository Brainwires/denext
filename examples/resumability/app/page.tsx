    ...
    <section>
      ...
      <ol class="steps">
        ...
        <li>
          ...
          <em>resumed ✅</em>, the count updates (the click is replayed to the
          now-live handler), and the console logs that single island — the
          others stay dormant.
        </li>
        <li>
          The <strong>clock</strong>{" "}
          resumes on its own, on idle: it is interactive via an effect, so the
          framework wakes it without a click.
        </li>
      </ol>
