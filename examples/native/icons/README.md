...
This example ships a full icon set — `app.icns` (macOS), `app.ico` (Windows),
and `app.png` (Linux) — already wired into the `desktop` block of `deno.json`,
so `deno task desktop:package` picks them up. Replace them with your own artwork
to rebrand.
